...
class AuthController extends ApiBaseController
{
    ...
    public function login()
    {
        ...
        $user = AuthService::checkUsernameForEmail($credentials['username'], UserType::END_USER, true);
        if (empty($user)) {
            $user = AuthService::checkUsernameForEmail($credentials['username'], UserType::END_USER, false);
            if (empty($user)) {
        ...
        $credentials['user_type'] = UserType::END_USER;
